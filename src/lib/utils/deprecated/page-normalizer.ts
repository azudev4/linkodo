 ...
 */
export function hasPageChanged(existing: DatabasePage, newPage: ProcessedOnCrawlPage, syncMode: SyncMode = SyncMode.FULL): boolean {
  ...
  // Incremental mode: Only check content fields (h1, title, meta, word_count)
